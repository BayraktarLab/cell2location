...
obs_data = pd.read_csv('/nfs/team205/vk7/sanger_projects/large_data/mouse_viseum_snrna/zeisel_integrated_meta.tsv',
                       sep="\t")
...
var = pd.read_csv(
    '/nfs/team205/vk7/sanger_projects/large_data/mouse_viseum_snrna/rawdata/filtered_feature_bc_matrix/5705STDY8058280/features.tsv.gz',
    sep='\t', header=None)
...
for seed in seeds:
    ...
    pickle.dump(lbl_generation,
                open("/nfs/team283/ed6/simulation/lowdens_synthetic_ST/labels_generation_" + str(seed) + ".p", "wb"))
    pickle.dump(cnt_generation,
                open("/nfs/team283/ed6/simulation/lowdens_synthetic_ST/counts_generation_" + str(seed) + ".p", "wb"))
    pickle.dump(lbl_validation,
                open("/nfs/team283/ed6/simulation/lowdens_synthetic_ST/labels_validation_" + str(seed) + ".p", "wb"))
    pickle.dump(cnt_validation,
                open("/nfs/team283/ed6/simulation/lowdens_synthetic_ST/counts_validation_" + str(seed) + ".p", "wb"))
