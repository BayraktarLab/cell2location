...
class Cell2location(QuantileMixin, PyroSampleMixin, PyroSviTrainMixin, PltExportMixin, BaseModelClass):
    ...
    **model_kwargs
    ...
    def setup_anndata(
        ...
        layer_normalised: Optional[str] = None,
        ...
        **kwargs,
        ...
        if layer_normalised is not None:
            anndata_fields.append(LayerField("x_data_normalised", layer_normalised, is_count_data=False))
        ...
        if normalising_factor_y_s_key is not None:
            anndata_fields.append(NumericalObsField("normalising_factor_y_s", normalising_factor_y_s_key))
