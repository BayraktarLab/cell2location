# -*- coding: utf-8 -*-
"""Negative binomial regression model with multiplicative sample scaling, gene-specific technology scaling
and additive sample background in pytorch.
...
class RegressionNBV4Torch(RegressionTorchModel):
    r"""RegressionNBV4Torch Negative binomial regression model with sample 
        gene-specific technology scaling in pytorch.
    :param sample_col: str with column name in cell2covar that denotes sample
